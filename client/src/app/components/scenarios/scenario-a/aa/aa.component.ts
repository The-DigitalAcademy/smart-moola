  ...
  verify() {
    ...
    switch (this.active) {
      case 'q1':
        ...
        this.tumiResponse = "Credit lets you buy expensive things that you couldn't afford with cash. ";
      ...
      case 'q2':
        ...
        break;
      case 'q3':
        this.question = 'Lerato, lets assume you want to get credit. What do you think will be needed from you to get credit? ';

        this.mandlaResponse = "Id and proof of residence";
        this.tumiResponse = "Id and pay slip";
        this.session.saveActiveQuestion('q4');
        break;
      case 'q4':
        this.question = 'Between Mandla and Tumi is correct about credit score ';

        this.mandlaResponse = "Credit Score is a type of vegetable grown in outer space.";
        this.tumiResponse = "Credit Score is used the is to check how do use your money.";
      ...
      case 'q5':
        ...
        break;
      case 'q6':
        this.question = 'Based on the previous senario who’s credit score is more likely to have a good credit score and has a better chance of qualifying for future credit?';

        this.mandlaResponse = "Mandla";
        this.tumiResponse = "Tumi";
        this.session.saveActiveQuestion('q7');
        break;
      case 'q7':
        this.question = 'Between Mandla and Tumi who is correct with debt definition';

        this.mandlaResponse = "Debt is money you save to buy things you can't afford right now..";
        this.tumiResponse = "Debt is the money one party owes another party, and can be paid over time ";
        this.session.saveActiveQuestion('q8');
        break;
      case 'q8':
        this.question = 'Between Mandla and Tumi who is correct about a debtor';
